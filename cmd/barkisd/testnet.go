...
import (
	...
	genutiltypes "github.com/FnyaMing/nainaide/x/genutil/types"
...
func testnetCmd(ctx *appconfig.ServerContext, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a nainaided testnet",
...
Example:
	nainaided testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "nainaided",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "nainaidecli",
...
func InitTestnet(cmd *cobra.Command, config *tmconfig.Config, cdc *codec.Codec,
	...
	nainaideConfig := appconfig.DefaultAppConfig()
	nainaideConfig.MinGasPrices = minGasPrices
	...
	for i := 0; i < numValidators; i++ {
		...
		nainaideConfigFilePath := filepath.Join(nodeDir, "config/nainaided.toml")
		appconfig.WriteConfigFile(nainaideConfigFilePath, nainaideConfig)
	}
