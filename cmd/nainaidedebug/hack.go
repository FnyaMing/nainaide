...
import (
	...
	nainaide "github.com/FnyaMing/nainaide/app"
)
...
func runHackCmd(cmd *cobra.Command, args []string) error {
	...
	db, err := sdk.NewLevelDB("nainaide", dataDir)
	if err != nil {
		fmt.Println(err)
		os.Exit(1)
	}
	app, keyMain, keyStaking, stakingKeeper := nainaide.NewnainaideAppUNSAFE(
