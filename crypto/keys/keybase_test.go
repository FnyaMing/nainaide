...
import (
	...
	"github.com/FnyaMing/nainaide/crypto/keys/hd"
...
func TestCreateLedger(t *testing.T) {
	...
	assert.Equal(t, "nainaidepub1addwnpepqdszcr95mrqqs8lw099aa9h8h906zmet22pmwe9vquzcgvnm93eqyx9egnq", pk)
...
func TestKeyManagement(t *testing.T) {
	...
	require.NoError(t, err)
	addr, err := sdk.AccAddressFromBech32("nainaide1ka54cl8ep6shtxajr5mvp6f7evj2zvf90qt544")
	require.NoError(t, err)
