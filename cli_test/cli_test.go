...
func TestnainaideCLIKeysAddMultisig(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLIKeysAddRecover(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLIKeysAddRecoverHDPath(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLIMinimumFees(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)

	// start nainaided server with minimum fees
...
func TestnainaideCLIGasPrices(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLIFeesDeduction(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLISend(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)

	// start nainaided server
	proc := f.GDStart()
	defer proc.Stop(false)
...
func TestnainaideCLIGasAuto(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLICreateValidator(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLIQueryRewards(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	cdc := app.MakeCodec()
	...
	genFile := filepath.Join(f.nainaidedHome, "config", "genesis.json")
...
func TestnainaideCLIQuerySupply(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLISubmitProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLISubmitParamChangeProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLISubmitCommunityPoolSpendProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLIQueryTxPagination(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLIValidateSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLISendGenerateSignAndBroadcast(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLIMultisignInsufficientCosigners(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLIEncode(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLIMultisignSortSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLIMultisign(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestnainaideCLIConfig(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	config, err := ioutil.ReadFile(path.Join(f.nainaidecliHome, "config", "config.toml"))
	require.NoError(t, err)
...
func TestnainaidedCollectGentxs(t *testing.T) {
	t.Parallel()
...
func TestnainaidedAddGenesisAccount(t *testing.T) {
	t.Parallel()
	f := NewFixtures(t)
