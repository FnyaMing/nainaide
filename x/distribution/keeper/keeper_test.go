...
func TestWithdrawValidatorCommission(t *testing.T) {
	...
	valCommission := sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec("unainaide", sdk.NewDec(3).Quo(sdk.NewDec(2))),
	}
	...
	distrAcc.SetCoins(sdk.NewCoins(
		...
		sdk.NewCoin("unainaide", sdk.NewInt(2)),
	))
	...
	expCoins := sdk.NewCoins(sdk.NewCoin("unainaide", expTokens))
	...
	require.Equal(t, sdk.NewCoins(
		...
		sdk.NewCoin("unainaide", expTokens.AddRaw(1)),
	), balance)
	...
	require.Equal(t, sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec("unainaide", sdk.NewDec(1).Quo(sdk.NewDec(2))),
	}, remainder)
