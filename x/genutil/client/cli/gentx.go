...
import (
	...
	kbkeys "github.com/FnyaMing/nainaide/crypto/keys"
...
// nolint: errcheck
func GenTxCmd(ctx *config.ServerContext, cdc *codec.Codec, mbm module.BasicManager, smbh StakingMsgBuildingHelpers,
