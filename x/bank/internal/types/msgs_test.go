...
func TestMsgSendGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"cosmos-sdk/MsgSend","value":{"amount":[{"amount":"10","denom":"atom"}],"from_address":"nainaide1d9h8qat5kqprja","to_address":"nainaide1da6hgur4wsp8ply6"}}`
...
func TestMsgMultiSendGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"cosmos-sdk/MsgMultiSend","value":{"inputs":[{"address":"nainaide1d9h8qat5kqprja","coins":[{"amount":"10","denom":"atom"}]}],"outputs":[{"address":"nainaide1da6hgur4wsp8ply6","coins":[{"amount":"10","denom":"atom"}]}]}}`
	require.Equal(t, expected, string(res))
}
