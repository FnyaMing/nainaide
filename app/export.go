...
// export the state of nainaide for a genesis file
func (app *nainaideApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
...
func (app *nainaideApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
