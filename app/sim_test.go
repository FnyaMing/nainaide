...
import (
	...
	authsim "github.com/FnyaMing/nainaide/x/auth/simulation"
	"github.com/FnyaMing/nainaide/x/bank"
	distr "github.com/FnyaMing/nainaide/x/distribution"
	distrsim "github.com/FnyaMing/nainaide/x/distribution/simulation"
	"github.com/FnyaMing/nainaide/x/gov"
	govsim "github.com/FnyaMing/nainaide/x/gov/simulation"
	"github.com/FnyaMing/nainaide/x/mint"
	"github.com/FnyaMing/nainaide/x/params"
	paramsim "github.com/FnyaMing/nainaide/x/params/simulation"
	"github.com/FnyaMing/nainaide/x/simulation"
	"github.com/FnyaMing/nainaide/x/slashing"
	slashingsim "github.com/FnyaMing/nainaide/x/slashing/simulation"
	"github.com/FnyaMing/nainaide/x/staking"
	stakingsim "github.com/FnyaMing/nainaide/x/staking/simulation"
...
func getSimulateFromSeedInput(tb testing.TB, w io.Writer, app *nainaideApp) (
...
func testAndRunTxs(app *nainaideApp) []simulation.WeightedOperation {
	cdc := MakeCodec()
...
func invariants(app *nainaideApp) []sdk.Invariant {
...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/cosmos/cosmos-sdk/nainaideApp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
func BenchmarkFullAppSimulation(b *testing.B) {
	...
	app := NewnainaideApp(logger, db, nil, true, 0)
...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewnainaideApp(logger, db, nil, true, 0, fauxMerkleModeOpt)
	require.Equal(t, "nainaideApp", app.Name())
...
func TestAppImportExport(t *testing.T) {
	...
	newApp := NewnainaideApp(log.NewNopLogger(), newDB, nil, true, 0, fauxMerkleModeOpt)
...
func TestAppSimulationAfterImport(t *testing.T) {
	...
	newApp := NewnainaideApp(log.NewNopLogger(), newDB, nil, true, 0, fauxMerkleModeOpt)
	require.Equal(t, "nainaideApp", newApp.Name())
