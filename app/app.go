...
import (
	...
	bam "github.com/FnyaMing/nainaide/baseapp"
...
var (
	...
	nainaideContext = config.NewDefaultContext()
)
...
func (app *nainaideApp) registerUpgrade() {
	//------------------------------------------------------------------------------------------------------------------------------------
	//Register upgrade height
	sdk.GlobalUpgradeMgr.RegisterUpgradeHeight(sdk.RewardUpgrade , nainaideContext.UpgradeConfig.RewardUpgrade)
	...
	sdk.GlobalUpgradeMgr.RegisterUpgradeHeight(sdk.TokenIssueUpgrade, nainaideContext.UpgradeConfig.TokenIssueHeight)
	...
	sdk.GlobalUpgradeMgr.RegisterBeginBlockerFirst(sdk.TokenIssueUpgrade, func(ctx sdk.Context) {
		...
		issueFee := sdk.NewCoins(sdk.NewCoin(sdk.DefaultBondDenom, sdk.NewInt(10000000000))) //10000nainaide
		mintFee := sdk.NewCoins(sdk.NewCoin(sdk.DefaultBondDenom, sdk.NewInt(5000000000))) //5000nainaide
	...
	//Register upgrade height
	sdk.GlobalUpgradeMgr.RegisterUpgradeHeight(sdk.UpdateVotingPeriodHeight , nainaideContext.UpgradeConfig.UpdateVotingPeriodHeight)
	...
	//------------------------------------------------------------------------------------------------------------------------------------
	sdk.GlobalUpgradeMgr.RegisterUpgradeHeight(sdk.UpdateTokenSymbolRulesHeight , nainaideContext.UpgradeConfig.UpdateTokenSymbolRulesHeight)

	sdk.GlobalUpgradeMgr.RegisterBeginBlockerFirst(sdk.UpdateTokenSymbolRulesHeight, func(ctx sdk.Context) {
		app.assetKeeper.SetIssueFee(ctx, sdk.NewCoins(sdk.NewCoin(sdk.DefaultBondDenom, sdk.NewInt(2000000000)))) //2000nainaide
		app.assetKeeper.SetMintFee(ctx, sdk.NewCoins(sdk.NewCoin(sdk.DefaultBondDenom, sdk.NewInt(1000000000)))) //1000nainaide
	})

	//------------------------------------------------------------------------------------------------------------------------------------
	sdk.GlobalUpgradeMgr.RegisterUpgradeHeight(sdk.TokenDesLenLimitUpgradeHeight, nainaideContext.UpgradeConfig.TokenDesLenLimitUpgradeHeight)
}

// application updates every begin block
func (app *nainaideApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
...
func (app *nainaideApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
...
func (app *nainaideApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *nainaideApp) LoadHeight(height int64) error {
	return app.LoadVersion(height, app.keys[bam.MainStoreKey])
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *nainaideApp) ModuleAccountAddrs() map[string]bool {
