...
import (
	...
	"github.com/FnyaMing/nainaide/client/keys"
	"github.com/FnyaMing/nainaide/crypto/keys/mintkey"
	...
	dclcommon "github.com/FnyaMing/nainaide/x/distribution/client/common"
	distrrest "github.com/FnyaMing/nainaide/x/distribution/client/rest"
	disttypes "github.com/FnyaMing/nainaide/x/distribution/types"
...
func TestValidators(t *testing.T) {
	...
	require.Contains(t, resultVals.Validators[0].Address.String(), "nainaidevalcons")
	require.Contains(t, resultVals.Validators[0].PubKey, "nainaidevalconspub")
...
func TestCoinSendGenerateSignAndBroadcast(t *testing.T) {
	...
	// simulate tx
	res, body, _ := doTransferWithGas(t, port, seed, name1, memo, "", addr, client.GasFlagAuto, 1.0, true, false, fees)
	require.Equal(t, http.StatusOK, res.StatusCode, body)
