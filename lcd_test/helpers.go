...
import (
	...
	"github.com/FnyaMing/nainaide/client/lcd"
	"github.com/FnyaMing/nainaide/codec"
	crkeys "github.com/FnyaMing/nainaide/crypto/keys"
	...
	authrest "github.com/FnyaMing/nainaide/x/auth/client/rest"
	...
	bapp "github.com/FnyaMing/nainaide/app"
)
...
func InitializeLCD(nValidators int, initAddrs []sdk.AccAddress, minting bool, portExt ...string) (
	...
	db := dbm.NewMemDB()
	app := bapp.NewnainaideApp(logger, db, nil, true, 0, baseapp.SetPruning(store.PruneNothing))
	cdc = bapp.MakeCodec()
...
func startTM(
	...
	privVal tmtypes.PrivValidator, app *bapp.nainaideApp,
) (*nm.Node, error) {
...
// NOTE: If making updates here also update cmd/nainaide/cmd/nainaidecli/main.go
func registerRoutes(rs *lcd.RestServer) {
	client.RegisterRoutes(rs.CliCtx, rs.Mux)
	authrest.RegisterTxRoutes(rs.CliCtx, rs.Mux)
	bapp.ModuleBasics.RegisterRESTRoutes(rs.CliCtx, rs.Mux)
}
